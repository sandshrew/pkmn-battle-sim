...
public class Main extends Application {
	...
	public void test(Stage primaryStage){
		...
		ramon = new Button("ramon");
		andrew = new Button("andrew");
		
		ramon.setOnAction(new EventHandler<ActionEvent>() {
			public void handle(ActionEvent e) {
				ButtonClicked(e);
			}
		});
		andrew.setOnAction(new EventHandler<ActionEvent>() {
			public void handle(ActionEvent e) {
				ButtonClicked(e);
			}
		});
		
		root.getChildren().add(andrew);
		root.getChildren().add(ramon);
		
		primaryStage.setScene(scene);
		primaryStage.show();
	}
	
	//TEST FUNCTION NOT MVC
